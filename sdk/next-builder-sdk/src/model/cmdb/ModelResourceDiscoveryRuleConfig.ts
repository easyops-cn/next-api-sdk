...
export interface ModelResourceDiscoveryRuleConfig {
  ...
  /** 容器服务聚类规则 */
  containerServiceRules: ModelResourceDiscoveryRuleConfig_containerServiceRules_item[];
...
export interface ModelResourceDiscoveryRuleConfig_containerServiceRules_item {
  /** 特征项 */
  feature?: string;
  ...
  /** 标签特征值 */
  labelValue?: ModelResourceDiscoveryRuleConfig_containerServiceRules_item_labelValue;
...
export interface ModelResourceDiscoveryRuleConfig_containerServiceRules_item_labelValue {
  /** 标签名 */
  key?: string;
