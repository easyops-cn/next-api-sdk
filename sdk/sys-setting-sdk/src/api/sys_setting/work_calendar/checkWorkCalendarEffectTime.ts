...
import { ModelEffectiveTime } from "../../../model/alert_service/index.js";
...
export const WorkCalendarApi_checkWorkCalendarEffectTime = async (
  ...
  /**! @contract easyops.api.sys_setting.work_calendar.CheckWorkCalendarEffectTime@1.1.0 */ (
    ...
    >(
      `api/gateway/sys_setting.work_calendar.CheckWorkCalendarEffectTime/api/sys_setting/v1/work/calendar/${id}/check_effect_time`,
      data,
      options
    )
  ).data;
